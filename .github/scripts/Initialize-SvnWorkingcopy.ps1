...
# Change Working directory to parent of config file, so that relative paths match
$configFileFolder = Split-Path $configFile
Push-Location -Path $configFileFolder
